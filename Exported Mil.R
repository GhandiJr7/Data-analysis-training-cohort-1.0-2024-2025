...
exported <- read.fortran("C:/Users/junio/OneDrive/Documents/Training data Analysis/Tabulations/R Projects/Mildred/Mildred's data/Exported.dat",c("I4","A10","A10","I1","A25","I2","A10","I1","I1","I1","I3","F5","I1","I4","F5","I3","F4","A10","I1","I2","I4","I2","I2","F5","F5","F5","F5","F5"))
...
write.xlsx(exported, "Mildred_data.xlsx")
